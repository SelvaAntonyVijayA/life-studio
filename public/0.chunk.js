...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_widgets_widgets_component__ = __webpack_require__("../../../../../src/app/components/widgets/widgets.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_home_home_routing_module__ = __webpack_require__("../../../../../src/app/components/home/home-routing.module.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_tiles_list_tiles_list_component__ = __webpack_require__("../../../../../src/app/components/tiles-list/tiles-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_widgets_tileblocks_components__ = __webpack_require__("../../../../../src/app/components/widgets/tileblocks.components.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__services_header_service__ = __webpack_require__("../../../../../src/app/services/header.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_widgets_tileblocks_directive__ = __webpack_require__("../../../../../src/app/components/widgets/tileblocks.directive.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_ng2_summernote_ng2_summernote__ = __webpack_require__("../../../../ng2-summernote/ng2-summernote.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_ng2_slimscroll__ = __webpack_require__("../../../../ng2-slimscroll/index.ts");
...
HomeModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgModule */])({
        imports: [
            __WEBPACK_IMPORTED_MODULE_1__angular_common__["b" /* CommonModule */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_5__components_home_home_routing_module__["a" /* HomeRoutingModule */], __WEBPACK_IMPORTED_MODULE_12_ng2_slimscroll__["a" /* SlimScrollModule */]
        ],
        entryComponents: [__WEBPACK_IMPORTED_MODULE_8__components_widgets_tileblocks_components__["d" /* TileBlocksComponents */]],
        declarations: [__WEBPACK_IMPORTED_MODULE_3__components_home_home_component__["a" /* HomeComponent */], __WEBPACK_IMPORTED_MODULE_6__components_header_header_component__["a" /* HeaderComponent */], __WEBPACK_IMPORTED_MODULE_4__components_widgets_widgets_component__["a" /* WidgetsComponent */], __WEBPACK_IMPORTED_MODULE_7__components_tiles_list_tiles_list_component__["a" /* TilesListComponent */], __WEBPACK_IMPORTED_MODULE_8__components_widgets_tileblocks_components__["d" /* TileBlocksComponents */], __WEBPACK_IMPORTED_MODULE_10__components_widgets_tileblocks_directive__["a" /* TileBlocksDirective */], __WEBPACK_IMPORTED_MODULE_11_ng2_summernote_ng2_summernote__["a" /* Ng2Summernote */]],
        providers: [__WEBPACK_IMPORTED_MODULE_9__services_header_service__["a" /* HeaderService */]]
    })
], HomeModule);
...
module.exports = "<div class=\"container\">\n  <div class=\"page_header\">\n    <img class=\"header_logo\" src=\"assets/img/header/QIL_logo.png\">\n    <div class=\"header_user_info\" style=\"bottom: 51px;\">\n      <select class=\"user_organization\" [(ngModel)]=\"defaultOrg\" (ngModelChange)=\"orgChange($event)\" id=\"ddUserOrganization\" style=\"display: inline-block;\">\n         \t<option [value]=-1 disabled>Select Organization</option>\n         <option [attr.id]=\"'orgOption' + i\" [attr.type]=\"org.type_id\" *ngFor=\"let org of orgs; let i = index\" [selected]=\"org === selectedOrg\" [ngValue]=\"org\" >{{org.name}}</option>\n      </select>\n      <a class=\"header_username\" (click)=\"accountPage()\" href=\"javascript:void(0);\"></a>\n      <a class=\"header_logout\" href=\"javascript:void(0);\">Logout</a>\n    </div>\n    <div class=\"navbar navbar-default\" id=\"ili_menu\">\n      <ul class=\"nav navbar-nav\" id=\"ili_menu_ulLeft\">\n        <li [attr.id]=\"menuLeft.id\" *ngFor=\"let menuLeft of menusDatas.left; let i = index;\">\n\n          <a [attr.id]=\"menuLeft.aId\" class=\"dropdown-toggle\" href=\"javascript:void(0);\" data-toggle=\"dropdown\" *ngIf=\"menuLeft.type.indexOf('multi') !== -1\">\n           {{menuLeft.text}}\n            <b class=\"caret\"></b>\n            </a>\n          <ul class=\"dropdown-menu\">\n            <li [attr.id]=\"subPage.id\" *ngFor=\"let subPage of menuLeft.subPages; let i = index;\">\n              <a href=\"javascript:void(0);\" (click)=\"loadPage(subPage)\" [attr.url]=\"subPage.url\" [attr.id]=\"subPage.aId\">{{subPage.name}}</a>\n            </li>\n          </ul>\n\n          <a [attr.id]=\"menuLeft.aId\" href=\"javascript:void(0);\" *ngIf=\"menuLeft.type.indexOf('single') !== -1\">\n            {{menuLeft.text}}\n            <b class=\"caret\"></b>\n            </a>\n          <ul class=\"dropdown-menu\">\n            <li [attr.id]=\"subPage.id\" *ngFor=\"let subPage of menuLeft.subPages; let i = index;\">\n              <a href=\"javascript:void(0);\" (click)=\"loadPage(subPage)\" [attr.url]=\"subPage.url\" [attr.id]=\"subPage.aId\">{{subPage.name}}</a>\n            </li>\n          </ul>\n        </li>\n      </ul>\n      <ul class=\"nav navbar-nav navbar-right\" id=\"ili_menu_ulRight\">\n        <li [attr.id]=\"menuRight.id\" *ngFor=\"let menuRight of menusDatas.right; let i = index;\">\n\n          <a [attr.id]=\"menuRight.aId\" class=\"dropdown-toggle\" href=\"javascript:void(0);\" data-toggle=\"dropdown\" *ngIf=\"menuRight.type.indexOf('multi') !== -1\">\n           {{menuRight.text}}\n            <b class=\"caret\"></b>\n            </a>\n          <ul class=\"dropdown-menu\">\n            <li [attr.id]=\"subPage.id\" *ngFor=\"let subPage of menuRight.subPages; let i = index;\">\n              <a href=\"javascript:void(0);\" (click)=\"loadPage(subPage)\" [attr.id]=\"subPage.aId\">{{subPage.name}}</a>\n            </li>\n          </ul>\n\n          <a [attr.id]=\"menuRight.aId\" href=\"javascript:void(0);\" *ngIf=\"menuRight.type.indexOf('single') !== -1\">\n            {{menuRight.text}}\n            <b class=\"caret\"></b>\n            </a>\n          <ul class=\"dropdown-menu\">\n            <li [attr.id]=\"subPage.id\" *ngFor=\"let subPage of menuRight.subPages; let i = index;\">\n              <a href=\"javascript:void(0);\" (click)=\"loadPage(subPage)\" [attr.id]=\"subPage.aId\">{{subPage.name}}</a>\n            </li>\n          </ul>\n        </li>\n      </ul>\n    </div>\n  </div>\n</div>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_header_service__ = __webpack_require__("../../../../../src/app/services/header.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__helpers_DomainPageLib__ = __webpack_require__("../../../../../src/app/helpers/DomainPageLib.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__helpers_Common__ = __webpack_require__("../../../../../src/app/helpers/Common.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HeaderComponent = (function () {
    function HeaderComponent(headerService, pageLib, cms, el, route, router) {
        ...
        this.domainDatas = function () {
            var _this = this;
            this.headerService.getDomainMenus(this.domainName).subscribe(function (domainDatas) {
                _this.dmDatas = domainDatas;
                _this.cms.rAcesss = !$.isEmptyObject(domainDatas[2]) && domainDatas[2].hasOwnProperty("role") ? domainDatas[2]["role"] : {};
                if (domainDatas[1].length > 0) {
                    if (domainDatas[1][0].hasOwnProperty('organizations')) {
                        _this.orgs = domainDatas[1][0]['organizations'];
                        _this.cms.organizations = domainDatas[1][0]['organizations'];
    ...
    HeaderComponent.prototype.orgChange = function (sOrg) {
        this.selectedOrg = sOrg;
    };
    HeaderComponent.prototype.createMenus = function () {
    };
    HeaderComponent.prototype.pageList = function () {
    ...
    ;
    HeaderComponent.prototype.loadPage = function (selected) {
        this.selectedPage = selected;
        this.router.navigate(['./widgets'], { relativeTo: this.route });
    };
    ;
    HeaderComponent.prototype.bindMenu = function (pages, ulBind, self) {
        var menuDatas = [];
    ...
    ;
    HeaderComponent.prototype.getAssignedPageRefresh = function () {
    ...
    ;
    HeaderComponent.prototype.engineAccesses = function (accesses) {
    ...
    ;
    HeaderComponent.prototype.processEngines = function (currentEngines, accesses) {
        var indexes = [];
        var newAccesses = [];
        if (accesses && accesses.length > 0) {
    ...
    ;
    HeaderComponent.prototype.headerPart = function () {
        if (this.dmDatas[0].length > 0) {
        }
    };
    ;
    HeaderComponent.prototype.accountPage = function () {
    };
    ;
...
HeaderComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_3__helpers_DomainPageLib__["a" /* DomainPageLib */], __WEBPACK_IMPORTED_MODULE_4__helpers_Common__["a" /* Common */]]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__services_header_service__["a" /* HeaderService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_header_service__["a" /* HeaderService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__helpers_DomainPageLib__["a" /* DomainPageLib */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__helpers_DomainPageLib__["a" /* DomainPageLib */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4__helpers_Common__["a" /* Common */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__helpers_Common__["a" /* Common */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* ElementRef */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* ElementRef */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _f || Object])
], HeaderComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_widgets_widgets_component__ = __webpack_require__("../../../../../src/app/components/widgets/widgets.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var homeRoutes = [
    {
        ...
        children: [
            {
                path: 'widgets',
                component: __WEBPACK_IMPORTED_MODULE_3__components_widgets_widgets_component__["a" /* WidgetsComponent */],
            }
        ]
    }
];
...
/***/ "../../../../../src/app/components/tiles-list/tiles-list.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".tiles_list {\r\n    border: 0px solid;\r\n    width: 292px;\r\n    height: 911px;\r\n    float: left;\r\n    margin-left: 1px;\r\n}\r\n\r\n.tiles_list_search {\r\n    padding-left: 10px;\r\n    padding-right: 8px;\r\n    text-align: center;\r\n    margin-top: 3px;\r\n    float: left;\r\n    width: 290px;\r\n}\r\n\r\n.filter_select_box {\r\n    margin-top: 5px;\r\n    width: 133px;\r\n    display: inline;\r\n}\r\n\r\n.orgs_box {\r\n    float: left;\r\n}\r\n\r\n.category_box {\r\n    float: right;\r\n    margin-right: 2px;\r\n}\r\n\r\n.tiles_sort {\r\n    float: left;\r\n    width: 284px;\r\n    margin-top: 4%;\r\n}\r\n\r\n.txt_arrange {\r\n    font-size: 11px;\r\n    float: left;\r\n    margin-top: 4px;\r\n    margin-left: 9px;\r\n}\r\n\r\n.sort_box {\r\n    float: left;\r\n    margin-left: 5px;\r\n    width: 86px;\r\n}\r\n\r\n.not_show{\r\n  display: none; \r\n  float:right;\r\n}\r\n\r\n.do_sort{\r\n    margin-right: 20px; \r\n    margin-top: 4px; \r\n    font-size: 11px; \r\n    cursor:pointer;\r\n}\r\n\r\n.sort_image{\r\n    margin-left: 5px;\r\n}\r\n\r\n.tiles_count_main{\r\n    width: 100%; \r\n    font-size: 12px; \r\n    float: left; \r\n    height: 1.5%; \r\n    margin-top: 3%;\r\n}\r\n\r\n.tile-view-change{\r\n    float: left; \r\n    margin-left: 17px;\r\n}\r\n\r\n.tile-view-change img{\r\n    cursor: pointer; \r\n    padding-right: 2px;\r\n}\r\n\r\n.tiles_list_count{\r\n    float: right; color:\r\n    #666666; \r\n    font-size: 80%; \r\n    padding-right: 7%; \r\n    padding-top: 5px;\r\n}\r\n\r\n.tiles_list_show_tiles{\r\n    padding-top: 1px; \r\n    padding-left: 10px; \r\n    height: 786px; \r\n    overflow: hidden; \r\n    margin-top: 120px;\r\n    width:280px;\r\n}\r\n\r\n.tiles_list_show_tiles{\r\n    padding-top: 1px; \r\n    padding-left: 10px; \r\n    height: 786px; \r\n    overflow: hidden; \r\n    margin-top: 120px; \r\n    width:280px;\r\n}\r\n\r\n", ""]);
...
/***/ "../../../../../src/app/components/tiles-list/tiles-list.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"page_block tiles_list\">\n    <div class='tiles_list_search'>\n      <input id='txtTileSearch' class='form-control input-sm search_box' type='text' placeholder='Search Tiles' />\n      <select id='drpdnTileOrgs' class=\"form-control input-sm filter_select_box orgs_box\"></select>\n      <select id='drpdnTileCategory' class=\"form-control input-sm filter_select_box category_box\"></select>\n    </div>\n    <div class=\"tiles_sort\">\n      <label class=\"txt_arrange\">Sort by: </label>\n      <select id='drpdnTileSort' class=\"form-control input-sm sort_box\" placeholder='Search'>\n        <option>Date</option>\n        <option value=\"name\">Title</option>\n        <option class=\"tile_content tile_url\">Category</option>\n        <option class=\"tile_content tile_url\">Author</option>\n        </select>\n      <div class=\"not_show do_sort date_sort\">\n        <div id='divDateOrderAsc' class='not_show date_asc'>\n          Oldest on top<img class=\"sort_image\" src='assets/img/sort_up.png' />\n        </div>\n        <div id='divDateOrderDesc' class='not_show date_desc'>\n          Newest on top<img class=\"sort_image\" src='assets/img/sort_down.png' />\n        </div>\n      </div>\n      <div class=\"not_show do_sort text_sort\">\n        <div class='not_show text_asc'>\n          A on top<img class=\"sort_image\" src='assets/img/sort_up.png' />\n        </div>\n        <div class='not_show text_desc'>\n          Z on top<img class=\"sort_image\" src='assets/img/sort_down.png' />\n        </div>\n      </div>\n    </div>\n    <div class='tiles_count_main'>\n      <div class=\"tile-view-change\">\n        <img id='imgTileViewDetail' src=\"assets/img/details.png\" alt=\"\" title=\"Details\" />\n        <img id='imgTileViewList' src=\"assets/img/list.png\" alt=\"\" title=\"List\" />\n      </div>\n      <div class='tiles_list_count'></div>\n    </div>\n    <div class='tiles_list_show tiles_list_show_tiles'>\n    </div>\n  </div>"

/***/ }),

/***/ "../../../../../src/app/components/tiles-list/tiles-list.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TilesListComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var TilesListComponent = (function () {
    function TilesListComponent() {
    }
    TilesListComponent.prototype.ngOnInit = function () {
    };
    return TilesListComponent;
}());
TilesListComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        selector: 'tiles-list',
        template: __webpack_require__("../../../../../src/app/components/tiles-list/tiles-list.component.html"),
        styles: [__webpack_require__("../../../../../src/app/components/tiles-list/tiles-list.component.css")]
    }),
    __metadata("design:paramtypes", [])
], TilesListComponent);

//# sourceMappingURL=tiles-list.component.js.map

/***/ }),

/***/ "../../../../../src/app/components/widgets/block-item.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BlockItem; });
var BlockItem = (function () {
    function BlockItem(component, block) {
...
//# sourceMappingURL=block-item.js.map

/***/ }),

/***/ "../../../../../src/app/components/widgets/tileblocks.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".tile_block {\r\n    width: 99.5%;\r\n    float: left;\r\n    z-index: 1px;\r\n    padding-left: 15px;\r\n    min-height: 35px;\r\n    padding-top: 10px;\r\n    padding-bottom: 10px;\r\n    margin-bottom: 10px;\r\n    margin-left: 4px;\r\n}\r\n\r\n.confirmation_text_block {\r\n    margin-top: 10px;\r\n    margin-bottom: 10px;\r\n}\r\n\r\n.url_block_url {\r\n    width: 97%;\r\n    margin-top: 10px;\r\n}\r\n\r\n.notes_panel {\r\n    width: 97%;\r\n}\r\n\r\n.contents_input_account {\r\n    margin-bottom: 1%;\r\n    margin-top: 1%;\r\n    width: 98%;\r\n    margin-left: auto;\r\n    margin-right: auto;\r\n    font-size: 11px;\r\n}\r\n\r\n.txt-email-notes {\r\n    font-size: 11px;\r\n}\r\n\r\n.url_block_url {\r\n    width: 97%;\r\n    margin-top: 10px;\r\n}\r\n\r\n.input-group-sm>.form-control {\r\n  font-size: 11px;\r\n}\r\n\r\n.content_buttons{\r\n    margin-bottom: 10px; \r\n    position: relative; \r\n    width: 100%; \r\n    text-align: right; \r\n    height: 15px;\r\n}\r\n\r\n.drag_cursor{ \r\n\r\n}\r\n\r\n.widgetstext{\r\n    position: relative; \r\n    float: left; \r\n    font-family: Verdana,Arial,sans-serif; \r\n    font-size: 0.8em;\r\n}\r\n\r\n.tigger_btn{\r\n    margin-right: 11px; \r\n    margin-top: 2px; \r\n    cursor: pointer; \r\n    float: right;\r\n}\r\n\r\n.redirect-app-submit{\r\n    float:right; \r\n    margin-right: 18px;\r\n}\r\n\r\n.redirect-back-app{\r\n    float: right; \r\n    font-weight: normal; \r\n    font-size: 11px; \r\n    font-size: 0.8em; \r\n    color: #666;\r\n}\r\n\r\n  /* Questionnaire Block */\r\n\r\n.survey_panel {\r\n    width: 98%;\r\n    float: left;\r\n    margin-top: 5px;\r\n    border-radius: 0px;\r\n    border-color: #ddd;\r\n    margin-bottom: 8px;\r\n}\r\n\r\n.text_header_content {\r\n    font-size: 92%;\r\n    float: left;\r\n    text-align: justify;\r\n    padding: 0 2%;\r\n}\r\n\r\n.survey_question_text {\r\n    width: 516px;\r\n    float: left;\r\n    margin-right: 5px;\r\n    margin-bottom: 5px;\r\n}\r\n\r\n.control_survey {\r\n    width: 98%;\r\n    float: left;\r\n}\r\n\r\n.decription-survey {\r\n    float: left;\r\n    margin-left: 30px;\r\n    margin-right: 5px;\r\n    padding: 0px 0px;\r\n    font-size: 93%;\r\n    margin-top: 1px;\r\n}\r\n\r\n.ques-one, .ques-multiple, .ques-radio, .ques-dropdown{\r\n    margin-top: 2px;\r\n}\r\n\r\n.control-app{\r\n    margin-left: 30px;\r\n}\r\n\r\n.survey_controls{\r\n    float: left;\r\n    margin-right: 11px;\r\n    width: 275px;\r\n    margin-bottom: 12px;\r\n}\r\n\r\n.survey-opts{\r\n    float: left;\r\n    margin-right: 12px;\r\n    margin-bottom: 12px;\r\n}\r\n\r\n.survey_text_row {\r\n    width: 87%;\r\n    float: left;\r\n    height: 4%;\r\n    margin-top: 10px;\r\n    padding: 0 4%;\r\n}\r\n\r\n.options-count {\r\n    float: left;\r\n    padding: 4px 5px 0 0;\r\n    width:23px;\r\n}\r\n\r\n.survey_option_box {\r\n    width: 473px;\r\n    float: left;\r\n    margin-bottom: 5px;\r\n}\r\n\r\n.delete-quest-option {\r\n    margin-left: 8px;\r\n    margin-top: 3px;\r\n    cursor: pointer;\r\n}\r\n\r\n.btn-questionnaire {\r\n    width: 88px;\r\n}\r\n\r\n.btn-add-text-box {\r\n    margin-bottom: 1px;\r\n    margin-top: 10px;\r\n    margin-left: 14px;\r\n}\r\n\r\n.chk-results, .enable-note{\r\n    margin-top: 2px;\r\n}\r\n\r\n.survey_add_alert {\r\n    width: 100%;\r\n}\r\n\r\n.survey-confirmation {\r\n    margin-left: 5px;\r\n    width: 105px;\r\n    float: right;\r\n}\r\n\r\n.btn-ques-alert {\r\n    width: 80px;\r\n    float: right;\r\n}\r\n\r\n.btn-popup-alert {\r\n    width: 80px;\r\n    float: right;\r\n    margin-right: 5px;\r\n}\r\n\r\n.survey-option-btn{\r\n  float: right;\r\n  margin-right: 14px;\r\n}\r\n\r\n", ""]);
...
/***/ "../../../../../src/app/components/widgets/tileblocks.components.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* unused harmony export BlockControls */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return InquiryBlockComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return NotesBlockComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return SurveyBlockComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return TileBlocksComponents; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var BlockControls = (function () {
    function BlockControls() {
        this.removeBlock = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* EventEmitter */]();
    }
    BlockControls.prototype.clearBlock = function (view) {
...
], BlockControls.prototype, "block", void 0);
BlockControls = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        ...
        styles: [__webpack_require__("../../../../../src/app/components/widgets/tileblocks.component.css")]
    })
], BlockControls);

var InquiryBlockComponent = (function () {
    function InquiryBlockComponent() {
        this.inquiryView = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* EventEmitter */]();
    }
    InquiryBlockComponent.prototype.deleteInquiry = function (view) {
        this.inquiryView.emit(view);
    };
    ;
    return InquiryBlockComponent;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* Input */])(),
    __metadata("design:type", Object)
], InquiryBlockComponent.prototype, "block", void 0);
InquiryBlockComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
...
var NotesBlockComponent = (function () {
    function NotesBlockComponent() {
        this.notesView = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* EventEmitter */]();
    }
    NotesBlockComponent.prototype.deleteNotes = function (view) {
        this.notesView.emit(view);
    };
    ;
    return NotesBlockComponent;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* Input */])(),
    __metadata("design:type", Object)
], NotesBlockComponent.prototype, "block", void 0);
NotesBlockComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
...
var TileBlocksDirective = (function () {
    function TileBlocksDirective(viewContainerRef) {
        this.viewContainerRef = viewContainerRef;
    }
    return TileBlocksDirective;
}());
TileBlocksDirective = __decorate([
...
var _a;
//# sourceMappingURL=tileblocks.directive.js.map
...
// module
exports.push([module.i, ".page_tile_content {\r\n    height: 920px;\r\n    width: 86.7%;\r\n    float: left;\r\n    margin: 1px 0px 0px 91px;\r\n}\r\n\r\n\r\n.tiles_head {\r\n    width: 739px;\r\n    height: 78px;\r\n    float: left;\r\n}\r\n\r\n.widgets_content_blocks {\r\n  position: relative;\r\n  width: 879px;\r\n  height: 833px;\r\n  float: left;\r\n}\r\n\r\n.tile_settings_count {\r\n    height: 1.5%;\r\n    margin-top: 3%;\r\n}\r\n\r\n/*Tiles Buttons */\r\n\r\n.tile_form_btns{\r\n   width: 390px;\r\n   float: left;\r\n   margin: 7px 0 0 0px;\r\n}\r\n\r\n.reset_tile_btn { \r\n  border-bottom-color: #228B22; \r\n  border-bottom-width: 3px;\r\n}\r\n\r\n.save_tile_btn { \r\n  border-bottom-color: #1E90FF; \r\n  border-bottom-width: 3px;\r\n}\r\n\r\n.duplicate_tile_btn { \r\n  border-bottom-color: #C71585; \r\n  border-bottom-width: 3px;\r\n}\r\n\r\n.delete_tile_btn { \r\n  border-bottom-color: #FF0000; \r\n  border-bottom-width: 3px;\r\n}\r\n\r\n.preview_tile_btn { \r\n  border-bottom-color: #2E8B57; \r\n  border-bottom-width: 3px;\r\n}\r\n\r\n/* Tile Prime */\r\n\r\n.tile_prime{\r\n  float:left;\r\n}\r\n\r\n.tile_prime .checkbox{\r\n  font-size: 11px;\r\n  color: #FFFFFF;\r\n  float: left;\r\n  padding-left: 10px;\r\n}\r\n\r\n.tile_prime .checkbox input[type=\"checkbox\"]{\r\n  margin-top: 2px;\r\n}\r\n\r\n.tile_language{\r\n  display: inline-block;\r\n}\r\n\r\n.tile_language .custom_combobox{\r\n  top: 9px; left: 13px;\r\n}\r\n\r\n#tileLanguage{\r\n  margin: 10px 2px 2px 11px; \r\n  height: 23px; \r\n  width: 166px;\r\n}\r\n\r\n.tile_form{\r\n  margin-top: 10px;\r\n  float:left;\r\n}\r\n\r\n.tile_title {\r\n    width: 255px;\r\n    display: inline-block;\r\n    float: left;\r\n}\r\n\r\n.tile_notes {\r\n    width: 175px;\r\n    margin-left: 5px;\r\n    margin-right: 5px;\r\n    display: inline-block;\r\n    float: left;\r\n}\r\n\r\n.template_box {\r\n    float: left;\r\n    margin-right: 5px;\r\n    width: 126px;\r\n    display: inline-block;\r\n}\r\n\r\n.tile_art{\r\n  width: 135px; \r\n  height: 77px;\r\n  float:left;\r\n  margin-left: 2px;\r\n  text-align: center;\r\n}\r\n\r\n.tile_art_img{\r\n    max-width: 120px;\r\n    max-height: 66px;\r\n    margin-top: 9px;\r\n}\r\n\r\n.tile_art_btn{\r\n  position: absolute; \r\n  top: 13; \r\n  left: 31px; \r\n  z-index: 1;\r\n}\r\n\r\n.custom_combobox {\r\n    color: black;\r\n    height: 25px;\r\n    width: 160px;\r\n    display: inline-block;\r\n    top: 0px;\r\n}\r\n\r\n.tile_cat_box{\r\n  width:167px;\r\n}\r\n\r\n.widgets_block {\r\n    width: 150px;\r\n    height: 833px;\r\n    text-align: center;\r\n    position:relative; \r\n    float: left;\r\n    margin-left: -1px;\r\n}\r\n\r\n  .widget-container{\r\n    float: left;\r\n    width: 876px;\r\n    height: 911px;\r\n  }\r\n   \r\n  /*Tile Widgets */\r\n\r\n.content_widget_btns{\r\n  position:relative; \r\n  top: 1%; \r\n  height: 833px; \r\n  overflow-y: hidden; \r\n  overflow-x: hidden; \r\n  float: left; \r\n  width: 100%;\r\n}\r\n\r\n.content_widget_btns .widget_btn{\r\n  padding-bottom:10px; \r\n  display:inline-block; \r\n  text-align: center; \r\n  cursor: pointer; \r\n  width: 48%; \r\n  float: left;\r\n}\r\n\r\n.content_widget_btns .widget_btn_separator{\r\n   margin-left: 12px;\r\n   margin-bottom: 15px;\r\n   display: inline-block;\r\n   position: relative;\r\n   text-align: center;\r\n   width: 80%;\r\n   float: left;\r\n   border: 0;\r\n   border-top: 0px solid #B5B8C8;\r\n}\r\n\r\n.content_widget_btns .normal-pointer{\r\n  cursor: default;\r\n}\r\n\r\n.content_widget_btns label{\r\n  font-size:9px;\r\n}\r\n\r\n.content_widget_btns img{\r\n  width:28px; \r\n  height:28px;\r\n}\r\n\r\n.widget-basic-collapse{\r\n  max-height: 142px; \r\n  overflow: hidden; cursor: \r\n  pointer; position: \r\n  relative; transition: 1s;\r\n}\r\n\r\n.widget-basic-collapse:hover{\r\n  max-height: 387px; \r\n  overflow: hidden; \r\n  cursor: pointer; \r\n  transition: 1s;\r\n}\r\n\r\n.widget-basic-collapse:hover .widgets-load-more{\r\n   display : none;\r\n}\r\n\r\n/* Widgets Separator */\r\n\r\n.separator-text{\r\n  text-align: center; \r\n  position: relative; \r\n  z-index: 2; \r\n  font-size: 12px;\r\n}\r\n\r\n.line-left{\r\n  position: absolute; \r\n  top: 50%; left: 0; \r\n  border-top: \r\n  solid 1px #B5B8C8; z-index: -1;\r\n}\r\n\r\n.line-right{\r\n  position: absolute; \r\n  top: 50%; right: 0; \r\n  border-top: solid 1px #B5B8C8; \r\n  z-index: -1;\r\n}\r\n\r\n.line-center {\r\n  margin: 0; \r\n  padding: 0 2px; \r\n  display: inline-block;\r\n}\r\n\r\n.line-restricted{\r\n  width: 23%;\r\n}\r\n\r\n.line-basic{\r\n  width: 33.5%;\r\n}\r\n\r\n.line-form{\r\n  width: 34%;\r\n}\r\n\r\n.line-exclusive{\r\n  width: 24%;\r\n}\r\n\r\n.widgets-load-more{\r\n  position: absolute; \r\n  bottom: -4px; \r\n  right: 20px; \r\n  font-weight: bolder;\r\n}\r\n\r\n.tile_blocks-content {\r\n    position: relative;\r\n    width: 726px;\r\n    height: 833px;\r\n    float: left;\r\n    margin-left: 1px;\r\n}\r\n\r\n.widget-forms-collapse{\r\n  max-height: 140px; \r\n  overflow: hidden; \r\n  cursor: pointer; \r\n  position: relative; \r\n  transition: 2s;\r\n}\r\n\r\n.widget-forms-collapse:hover{\r\n  max-height: 545px; \r\n  overflow: hidden; \r\n  cursor: pointer; \r\n  transition: 2s;\r\n}\r\n\r\n.widget-forms-collapse:hover .widgets-load-more {\r\n  display: none;\r\n}\r\n\r\n.widget-restricted-collapse{\r\n    max-height: 140px;\r\n   overflow: hidden; \r\n   cursor: pointer; \r\n   position: relative; \r\n   transition: 1s;\r\n  }\r\n\r\n.widget-restricted-collapse:hover{\r\n  max-height: 300px; \r\n  overflow: hidden; \r\n  cursor: pointer; \r\n  transition: 1s;\r\n}\r\n\r\n.widget-restricted-collapse:hover .widgets-load-more{\r\n  display: none;\r\n}\r\n\r\n.widget-exclusive-collapse{\r\n  max-height: 140px; \r\n  overflow: hidden; \r\n  cursor: pointer; \r\n  transition: 1s;\r\n}\r\n\r\n.widget-exclusive-collapse:hover{\r\n  max-height: 190px; \r\n  overflow: hidden; \r\n  cursor: pointer; \r\n  transition: 1s;\r\n}\r\n\r\n.widget-exclusive-collapse:hover .widgets-load-more{\r\n    display : none;\r\n}\r\n\r\n.widget-exclusive-collapse:hover .exclusive-widgets-load-more{\r\n   display : none;\r\n}\r\n\r\n.exclusive-widgets-load-more{\r\n  position: relative; \r\n  bottom: 0px; \r\n  top: 124px; \r\n  right: 20px; \r\n  font-weight: bolder;\r\n}\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n", ""]);
...
module.exports = "<div class=\"page_tile_content\">\n  <div class=\"widget-container\">\n    <div class=\"tiles_head\">\n      <div class=\"tile_form_btns\">\n        <button id=\"btnTileNew\" (click)=\"resetTile($event)\" class=\"ili-btn reset_tile_btn\">\n          New\n        </button>\n        <button id=\"btnTileSave\" (click)=\"saveBlocks()\" class=\"ili-btn save_tile_btn\">\n          Save\n        </button>\n        <button id=\"btnTileDuplicate\" class=\"ili-btn duplicate_tile_btn\">\n          Duplicate\n        </button>\n        <button id=\"btnTileDelete\" class=\"ili-btn delete_tile_btn\">\n          Delete\n        </button>\n        <button id=\"btnTilePreview\" class=\"ili-btn preview_tile_btn\">\n          Preview\n      </button>\n      </div>\n      <div class='tile_prime'>\n        <div class=\"checkbox\">\n          <label><input id=\"chkRtl\" type=\"checkbox\"> Right To Left</label>\n        </div>\n        <div class=\"checkbox\" style=\"margin-left: 4px; margin-top: 10px; float: left;\">\n          <label> <input id=\"chkPrime\" type=\"checkbox\">Premium</label>\n        </div>\n        <div class=\"tile_language\">\n          <select class=\"form-control input-sm\" id=\"tileLanguage\" placeholder=\"Select Language\"></select>\n        </div>\n      </div>\n      <div class=\"tile_form\">\n        <input id=\"txtTileTitle\" class=\"ili-form tile_title\" placeholder=\"Title\" type=\"text\">\n        <input id=\"txtTileTags\" class=\"ili-form tile_notes\" placeholder=\"Tags\" type=\"text\">\n        <select id=\"tileTemplate\" class=\"ili-form template_box\" placeholder=\"Select Template\"></select>\n        <select id=\"tileCategory\" class=\"ili-form tile_cat_box\" placeholder=\"Select / Add Category\"></select>\n      </div>\n    </div>\n    <div class=\"tile_art\">\n      <img class=\"tile_art_img\" src=\"/assets/img/ili-bg/bg_panels/tile_art_panel.png\">\n      <div class=\"tile_art_name\" style=\"display: block;\">\n      </div>\n    </div>\n\n    <div class=\"widgets_content_blocks\">\n      <div class=\"page_block widgets_block\">\n        <div class=\"scroll-window\" slimScroll [options]=\"opts\" style=\"height: 833px;\">\n          <div class=\"content_widget_btns\">\n            <div class='widget-basic-collapse'>\n              <div class='widget_btn_separator'>\n                <div class='separator-text'><span class='line-left line-basic'></span><span class='line-center' title='Basic widgets can be intermixed, or mixed with any other widgets.'>Basic</span>\n                  <span\n                    class='line-right line-basic'></span>\n                </div>\n              </div>\n\n              <div id='widgetEditor' block='Text' data-placement='top' title='Add any description in multiple paragraphs.' class='widget_btn'>\n                <div><img src='assets/img/text_32.png' /></div>\n                <div><label>Editor</label></div>\n              </div>\n\n              <div id='widgetUploadVideo' block='Video' data-toggle='tooltip' title='Upload a video file' class='widget_btn'>\n                <div><img src='assets/img/video_32.png' /></div>\n                <div><label>Upload Video</label></div>\n              </div>\n\n              <div id='widgetPicture' block='picture' data-toggle='tooltip' title='Allow users to upload their own pictures.  Select Moderate if you want pictures to be moderated before being published.'\n                class='widget_btn'>\n                <div><img src='assets/img/camara.png' /></div>\n                <div><label>Event Media</label></div>\n              </div>\n\n              <div id='widgetDisqus' block='disqus' data-toggle='tooltip' title='Disqus allows to create a discussion room amongst users. It helps you build a community of active readers and commenters.'\n                class='widget_btn'>\n                <div><img src='assets/img/disqus.png' /></div>\n                <div><label>Disqus</label></div>\n              </div>\n\n              <div id='widgetSocialFeed' block='feed' data-toggle='tooltip' title='Integrate FB and Twitter' class='widget_btn'>\n                <div><img src='assets/img/icon-feed.png' /></div>\n                <div><label>Social Feed</label></div>\n              </div>\n\n              <div id='widgetCalendar' block='calendar' data-toggle='tooltip' title='This Widget allows to create calendar' class='widget_btn'>\n                <div><img src='assets/img/calendar.png' /></div>\n                <div><label>Calendar</label></div>\n              </div>\n\n              <div id='widgetShare' block='share' data-toggle='tooltip' title='Share this Tile as a URL.' class='widget_btn'>\n                <div><img src='assets/img/share_this.png' /></div>\n                <div><label>Share</label></div>\n              </div>\n\n              <div id='widgetPatient' block='patients' data-toggle='tooltip' title='Show the list of patients by clinic' class='widget_btn'>\n                <div><img src='assets/img/patient.png' /></div>\n                <div><label>Patients</label></div>\n              </div>\n\n              <div class='widgets-load-more'>. . .</div>\n            </div>\n            <div id='divTileWidgetFormsCollapse' class='widget-forms-collapse'>\n              <div class='widget_btn_separator'>\n                <div class='separator-text'><span class='line-left line-form'></span><span class='line-center' title='Multiple Form widgets may be used in the same Tile. Each has its own Submit button. To create a Form with a group of widgets and a unique submit button, add the Form widgets between a Title and a Confirmation.'>Form</span>\n                  <span\n                    class='line-right line-form'></span>\n                </div>\n              </div>\n\n              <div id='widgetStartWrapper' block='StartWrapper' data-toggle='tooltip' title='Wrap multiple Form Widgets into one form'\n                class='widget_btn'>\n                <div><img src='assets/img/start_wrapper.png' /></div>\n                <div><label>Start Wrapper</label></div>\n              </div>\n\n              <div id='widgetTitle' block='title' data-toggle='tooltip' title='Title that will appear over any form you create' class='widget_btn'>\n                <div><img src='assets/img/form.png' /></div>\n                <div><label>Form Title</label></div>\n              </div>\n\n              <div id='widgetAccount' block='Account' data-toggle='tooltip' title='Name, DOB, Gender, Phone, email etc. Select the fields you want to appear in the app.'\n                class='widget_btn'>\n                <div><img src='assets/img/profile.png' /></div>\n                <div><label>Connection&nbsp;Card</label></div>\n              </div>\n\n              <div id='widgetAttendance' block='Attendance' data-toggle='tooltip' title='Users can select if they are attending In-Person or Online'\n                class='widget_btn'>\n                <div><img src='assets/img/clock.png' /></div>\n                <div><label>Attendance</label></div>\n              </div>\n\n              <div id='widgetSurvey' block='Survey' data-toggle='tooltip' data-toggle='tooltip' title='Multiple questions where users can select only One or Multiple answers.  Percentages can be shown in-app.'\n                class='widget_btn'>\n                <div><img (click)='loadWidgets(\"survey\")' src='assets/img/survey1.png' /></div>\n                <div><label>Questionnaire</label></div>\n              </div>\n\n              <div id='widgetQuestionnaire' block='questionnaire' data-toggle='tooltip' data-toggle='tooltip' title='Multiple questions where users can select only One or Multiple answers.  Percentages can be shown in-app.'\n                class='widget_btn'>\n                <div><img src='assets/img/survey.png' /></div>\n                <div><label>Cascading Questionnaire</label></div>\n              </div>\n\n              <div id='widgetQuestions' block='questions' data-toggle='tooltip' title='One or more questions requiring users to type their answers.'\n                class='widget_btn'>\n                <div><img src='assets/img/QA.png' /></div>\n                <div><label>Q & A</label></div>\n              </div>\n\n              <div id='widgetInquiry' block='inquiry' data-toggle='tooltip' title='Add Inquiry at the bottom of a Tile to allow users to send inquiries about the subject discussed in that Tile. Inquiries are directed to the email entered in the Tile.'\n                class='widget_btn'>\n                <div><img (click)='loadWidgets(\"inquiry\")' src='assets/img/inquery.png' /></div>\n                <div><label>Inquiry</label></div>\n              </div>\n\n              <div id='widgetProfile' block='Profile' data-toggle='tooltip' title='Add profile to update user information' class='widget_btn'>\n                <div><img src='assets/img/my-account.png' /></div>\n                <div><label>Profile</label></div>\n              </div>\n\n              <div id='widgetConfirmation' block='confirmation' data-toggle='tooltip' title='Confirmation page after user submits a form. In case there is no confirmation page, a default message is shown in the app. If you use a confirmation, then your own message appears.'\n                class='widget_btn'>\n                <div><img src='assets/img/confirm.png' /></div>\n                <div><label>Confirmation</label></div>\n              </div>\n\n              <div id='widgetPassword' block='password' data-toggle='tooltip' title='Password allows us to change the password for the registered users'\n                class='widget_btn'>\n                <div><img src='assets/img/icon_password.png' /></div>\n                <div><label>Password</label></div>\n              </div>\n\n              <div id='widgetNext' block='next' data-toggle='tooltip' title='Next tile page shows after user submits a form.' class='widget_btn'>\n                <div><img src='assets/img/arrow_next_icon.png' /></div>\n                <div><label>Next</label></div>\n              </div>\n              <!-- html += \"<div id='widgetUser' block='user' data-toggle='tooltip' title='User is to update and add new user.' class='widget_btn'>\";\n                <div><img src='/img/user_widget_icon.png'/></div>\n                <div><label>User</label></div>\n              </div> -->\n              <div id='widgetFormPhoto' block='FormPhoto' data-toggle='tooltip' title='Attach Photos to the form' class='widget_btn'>\n                <div><img src='assets/img/form_photo_widget.png' /></div>\n                <div><label>Form Media</label></div>\n              </div>\n\n              <div id='widgetPainLevel' block='PainLevel' data-toggle='tooltip' title='Denotes pain level' class='widget_btn'>\n                <div><img src='assets/img/pain_level.png' /></div>\n                <div><label>Pain Level</label></div>\n              </div>\n\n              <div id='widgetDrawTool' block='DrawTool' data-toggle='tooltip' title='You can draw on a picture or just on a blank screen to draw angles and pictures of a angle iron for instance'\n                class='widget_btn'>\n                <div><img src='assets/img/draw_tool.png' /></div>\n                <div><label>Draw Tool</label></div>\n              </div>\n\n              <div id='widgetPhysician' block='Physician' data-toggle='tooltip' title='Assign a physician to the patient' class='widget_btn'>\n                <div><img src='assets/img/physician.png' /></div>\n                <div><label>Physician</label></div>\n              </div>\n              <!-- <div id='widgetMobileVideo' block='MobileVideo' data-toggle='tooltip' title='Upload Mobile Video' class='widget_btn'>\n                <div><img src='/img/mobile-video.png'/></div>\n                <div><label>Mobile Video</label></div>\n              </div>-->\n              <div id='widgetEndWrapper' block='EndWrapper' data-toggle='tooltip' title='Wrap multiple Form Widgets into one form' class='widget_btn'>\n                <div><img src='assets/img/stop_wrapper.png' /></div>\n                <div><label>End Wrapper</label></div>\n              </div>\n\n              <div class='widgets-load-more'>. . .</div>\n            </div>\n\n            <div class='widget-restricted-collapse'>\n              <div class='widget_btn_separator'>\n                <div class='separator-text'><span class='line-left line-restricted'></span><span class='line-center' title='A restricted widget cannot be combined with a form widget.'>Restricted</span>\n                  <span\n                    class='line-right line-restricted'></span>\n                </div>\n              </div>\n              <div id='widgetFill' block='fill' data-toggle='tooltip' title='Fill-in the blanks. Type the text and let users fill-in the blanks. Enter 3 underscores ___ for the blank words.  You may use multiple 3 underscores in a row, but add a space after the 3rd.'\n                class='widget_btn'>\n                <div><img src='assets/img/fill.png' /></div>\n                <div><label>Fill-In</label></div>\n              </div>\n\n              <div id='widgetNotes' block='notes' data-toggle='tooltip' title='Users can take their own notes.' class='widget_btn'>\n                <div><img (click)='loadWidgets(\"notes\")' src='assets/img/notes.png' /></div>\n                <div><label>Notes</label></div>\n              </div>\n\n              <div id='widgetButtons' block='buttons' data-toggle='tooltip' title='Multiple buttons can be added, with before click and after click values. User can toggle between buttons, only the last value is taken into account.'\n                class='widget_btn'>\n                <div><img src='assets/img/buttons.png' /></div>\n                <div><label>Buttons</label></div>\n              </div>\n\n              <div id='widgetContactUs' block='contactus' data-toggle='tooltip' title='Users enter their information requesting you to contact them.  You will receive an email with their contact info.'\n                class='widget_btn'>\n                <div><img src='assets/img/icon-email.png' /></div>\n                <div><label>Contact Us</label></div>\n              </div>\n\n              <div id='widgetPlacefull' block='placefull' data-toggle='tooltip' title='PlaceFull event booking and ticketing' class='widget_btn'>\n                <div><img src='assets/img/pf_logo.png' /></div>\n                <div><label>PlaceFull</label></div>\n              </div>\n\n              <div id='widgetAddToCart' block='AddToCart' data-toggle='tooltip' title='You can cart your order' class='widget_btn'>\n                <div><img src='assets/img/icon_add_to_cart.png' /></div>\n                <div><label>Add to Cart</label></div>\n              </div>\n\n              <div id='widgetCart' block='Cart' data-toggle='tooltip' title='You can view all your carts' class='widget_btn'>\n                <div><img src='assets/img/icon_cart.png' /></div>\n                <div><label>Cart</label></div>\n              </div>\n\n              <div id='widgetBlanksForm' block='blanksform' data-toggle='tooltip' title='In-app form fill with picture upload and email alert'\n                class='widget_btn'>\n                <div><img src='assets/img/blank_form.png' /></div>\n                <div><label>Blank Form</label></div>\n              </div>\n\n              <div class='widgets-load-more'>. . .</div>\n            </div>\n            <div class='widget-exclusive-collapse'>\n              <div class='widget_btn_separator'>\n                <div class='separator-text'><span class='line-left line-exclusive'></span><span class='line-center' title='An exclusive widget cannot be combined with other widgets.'>Exclusive</span>\n                  <span\n                    class='line-right line-exclusive'></span>\n                </div>\n              </div>\n\n              <div id='widgetExclusiveUrl' block='exclusiveUrl' data-toggle='tooltip' title='Integrate URL' class='widget_btn'>\n                <div><img src='assets/img/icon_url.png' /></div>\n                <div><label>URL</label></div>\n              </div>\n\n              <div id='widgetFileUpload' block='fileupload' data-toggle='tooltip' title='Upload PDF or other format files' class='widget_btn'>\n                <div><img src='assets/img/uploads-icon.png' /></div>\n                <div><label>File Upload</label></div>\n              </div>\n\n              <div id='widgetPushpay' block='pushpay' data-toggle='tooltip' title='Integrate PushPay' class='widget_btn'>\n                <div><img src='assets/img/pushpay.png' /></div>\n                <div><label>PushPay</label></div>\n              </div>\n              <div block='threedcart' data-toggle='tooltip' title='Integrate 3dcart' class='widget_btn'>\n                <div><img src='assets/img/3d-cart.png' /></div>\n                <div><label>3dcart</label></div>\n              </div>\n\n              <div id='widgetBlogs' block='blogs' data-toggle='tooltip' title='Integrate Blogs' class='widget_btn'>\n                <div><img src='assets/img/icon-blogs.png' /></div>\n                <div><label>Blogs</label></div>\n              </div>\n\n              <div id='widgetChat' block='chat' data-toggle='tooltip' title='Enable chat within the app.' class='widget_btn'>\n                <div><img src='assets/img/chat.png' /></div>\n                <div><label>Chat</label></div>\n              </div>\n              <div class='exclusive-widgets-load-more'>. . .</div>\n            </div>\n          </div>\n        </div>\n      </div>\n      <!-- Tile Widgets Blocks -->\n\n      <div class=\"page_block tile_blocks-content\">\n        <div class=\"scroll-window\" style=\"width:98.9%; height: 833px\" slimScroll [options]=\"opts\">\n          <ng-template block-selected></ng-template>\n        </div>\n\n      </div>\n    </div>\n\n  </div>\n  <tiles-list></tiles-list>\n</div>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tileblocks_directive__ = __webpack_require__("../../../../../src/app/components/widgets/tileblocks.directive.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__block_item__ = __webpack_require__("../../../../../src/app/components/widgets/block-item.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tileblocks_components__ = __webpack_require__("../../../../../src/app/components/widgets/tileblocks.components.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var WidgetsComponent = (function () {
    function WidgetsComponent(componentFactoryResolver, elemRef) {
        this.componentFactoryResolver = componentFactoryResolver;
        this.currentAddIndex = -1;
    }
    /* Set Scroll Options */
    WidgetsComponent.prototype.setScrollOptions = function () {
        this.opts = {
            position: 'right',
    ...
    WidgetsComponent.prototype.loadWidgets = function (type, data) {
        var blocks = this.blocks;
        var viewName = "";
        if (type === "notes") {
            this.blocks.push(new __WEBPACK_IMPORTED_MODULE_2__block_item__["a" /* BlockItem */](__WEBPACK_IMPORTED_MODULE_3__tileblocks_components__["b" /* NotesBlockComponent */], { "type": "notes", "blockName": "Notes" }));
            viewName = "notesView";
        }
        if (type === "inquiry") {
            blocks.push(new __WEBPACK_IMPORTED_MODULE_2__block_item__["a" /* BlockItem */](__WEBPACK_IMPORTED_MODULE_3__tileblocks_components__["a" /* InquiryBlockComponent */], { "type": "inquiry", "blockName": "Inquiry", "data": { "email": "", "inquiryText": "" } }));
            viewName = "inquiryView";
        }
        if (type === "survey") {
            blocks.push(new __WEBPACK_IMPORTED_MODULE_2__block_item__["a" /* BlockItem */](__WEBPACK_IMPORTED_MODULE_3__tileblocks_components__["c" /* SurveyBlockComponent */], { "type": "survey", "blockName": "Questionnaire", "data": { "controls": "radio", "multiple": "true", "showInApp": "false", "isNote": "false", "questions": [""] } }));
            viewName = "surveyView";
        }
    ...
    WidgetsComponent.prototype.deleteBlock = function (view) {
        var index = this.blockSelected.viewContainerRef.indexOf(view);
        this.blockSelected.viewContainerRef.remove(index);
        this.blocks.splice(0, 1);
        this.currentAddIndex = this.currentAddIndex - 1;
    };
    WidgetsComponent.prototype.resetTile = function (e) {
        if (this.blocks.length > 0) {
            var viewContainerRef = this.blockSelected.viewContainerRef;
            viewContainerRef.clear();
            this.blocks = [];
            this.currentAddIndex = -1;
        }
    };
    WidgetsComponent.prototype.saveBlocks = function (e) {
        var result = this.blocks;
    };
    ;
    /* Loading the block components */
    WidgetsComponent.prototype.loadComponent = function (viewName) {
        var _this = this;
        this.currentAddIndex = this.currentAddIndex + 1;
        var adBlock = this.blocks[this.currentAddIndex];
        var componentFactory = this.componentFactoryResolver.resolveComponentFactory(adBlock.component);
        var viewContainerRef = this.blockSelected.viewContainerRef;
        //viewContainerRef.clear();
        var componentRef = viewContainerRef.createComponent(componentFactory);
        adBlock.block["view"] = componentRef.hostView;
        componentRef.instance[viewName].subscribe(function (view) { return _this.deleteBlock(view); });
        componentRef.instance.block = adBlock.block;
    };
...
], WidgetsComponent.prototype, "blocks", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_16" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_1__tileblocks_directive__["a" /* TileBlocksDirective */]),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__tileblocks_directive__["a" /* TileBlocksDirective */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__tileblocks_directive__["a" /* TileBlocksDirective */]) === "function" && _a || Object)
], WidgetsComponent.prototype, "blockSelected", void 0);
WidgetsComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        selector: 'app-widgets',
        template: __webpack_require__("../../../../../src/app/components/widgets/widgets.component.html"),
        styles: [__webpack_require__("../../../../../src/app/components/widgets/widgets.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["q" /* ComponentFactoryResolver */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["q" /* ComponentFactoryResolver */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* ElementRef */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* ElementRef */]) === "function" && _c || Object])
], WidgetsComponent);
...
/***/ "../../../../../src/app/helpers/DomainPageLib.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DomainPageLib; });
var DomainPageLib = (function () {
    function DomainPageLib() {
        this.Widgets = '/widgets';
        this.Themes = '/tilethemes';
        this.Events = '/events';
        this.Folders = '/tilist';
        this.Categories = '/categories';
        this.Pages = '/pages';
        this.Studio_Users = '/studiousers';
        this.Organizations = '/organizations';
        this.Event_Triggers = '/eventtriggers';
        this.Photos = '/photos';
        this.Videos = '/videos';
        this.In_app_Membership = '/inappmembership';
        this.Health_Status_Rules = '/healthstatusrules';
        this.Settings = '/settings';
        this.Activity_Reports = '/activityreports';
        this.End_Users = '/endusers';
        this.Registration = '/registration';
        this.End_User_Roles = '/enduserroles';
        this.SMART = '/smart';
        this.Notifications = '/notifications';
        this.Push_Notifications = '/pushnotifications';
        this.Studio_Role_Definitions = '/studioroledefinitions';
        this.Basic_Stream = '/basicstream';
        this.Advanced_Stream = '/advancedstream';
        this.Procedures = '/procedures';
        this.Procedure_Mapping = '/proceduremapping';
        this.Patient_Status = '/patientstatus';
        this.User_Access = '/useraccess';
        this.Stream_Url = '/streamurl';
        this.Chat_Gifts = '/chatgifts';
        this.Reports = '/reports';
        this.Auth_and_Security = '/authsecurity';
        this.User_Profile = '/userprofile';
        this.Packages = "/packages";
        this.Report_Generator = "/reportgenerator";
        this.Trend_Reports = "/trendreports";
        this.Trend_Alerts = "/trendalerts";
        this.Profile_Builder = "/profilebuilder";
        this.Standalone_Chat = "/standalonechat";
        this.Clinics_and_Physicians = "/clinicphysicians";
        this.QA_Weights = "/qaweights";
    }
    return DomainPageLib;
}());

;
//# sourceMappingURL=DomainPageLib.js.map
...
var HeaderService = (function () {
    function HeaderService(http) {
        ...
        this.domainUrl = ["/domain/get/", "/user/get", "/user/session"];
    }
    HeaderService.prototype.getDomainMenus = function (name) {
        var domainMenus = this.http.post(this.domainUrl[0], JSON.stringify({ "domainName": name }), { headers: this.headers }).toPromise().then(function (response) { return response.json(); }).catch(this.handleError);
        var userOrgs = this.http.get(this.domainUrl[1]).toPromise().then(function (response) { return response.json(); }).catch(this.handleError);
        var rAccess = this.http.get(this.domainUrl[2]).toPromise().then(function (response) { return response.json(); }).catch(this.handleError);
        /*return this.http
          .post(this.domainUrl, JSON.stringify({ "domainName": name }), { headers: this.headers })
          .toPromise()
          .then(response => response.json())
          .catch(this.handleError);*/
        return __WEBPACK_IMPORTED_MODULE_2_rxjs__["Observable"].forkJoin([domainMenus, userOrgs, rAccess]);
    };
...
/***/ "../../../../ng2-summernote/ng2-summernote.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Ng2Summernote; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
...
var Ng2Summernote = Ng2Summernote_1 = (function () {
...
Ng2Summernote = Ng2Summernote_1 = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        selector: 'ng2-summernote',
        providers: [
            {
                provide: __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* NG_VALUE_ACCESSOR */],
                useExisting: Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_24" /* forwardRef */])(function () { return Ng2Summernote_1; }),
                multi: true
            }
        ],
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* ElementRef */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* ElementRef */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["R" /* NgZone */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["R" /* NgZone */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__angular_http__["b" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_http__["b" /* Http */]) === "function" && _c || Object])
], Ng2Summernote);

var Ng2Summernote_1, _a, _b, _c;
//# sourceMappingURL=ng2-summernote.js.map

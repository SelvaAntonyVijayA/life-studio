...
export class NgSelectComponent implements OnInit, OnDestroy, OnChanges, AfterViewInit, ControlValueAccessor {
    ...
    @Output('selectchange') changeEvent = new EventEmitter();
    ...
    @Output('inputchange') selectChangeEvent = new EventEmitter();
    ...
    onSelectChangeEvent(e: any, term: string) {
        this.isFocused = false;
        var isNotFound = this.showNoItemsFound();
        var obj = {};
        obj["term"] = term;
        obj["isNotFound"] = isNotFound;

        this.selectChangeEvent.emit(obj);

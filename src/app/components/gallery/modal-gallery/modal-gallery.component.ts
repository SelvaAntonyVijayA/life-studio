...
import {
  ButtonEvent, ButtonsConfig, Image, ImageModalEvent, Action, Description, KeyboardConfig, LoadingConfig,
  PreviewConfig, SlideConfig, AccessibilityConfig, DotsConfig, InternalLibImage, AdvancedLayout, PlainGalleryConfig
} from '../../../models/gallery';

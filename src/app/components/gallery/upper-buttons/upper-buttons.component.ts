...
import { ButtonConfig, Action, ButtonEvent, ButtonsConfig, ButtonsStrategy, ButtonType, WHITELIST_BUTTON_TYPES, Image, Size } from '../../../models/gallery';
import { AccessibleComponent } from '../accessible.component';
import { NEXT } from '../../../helpers/gallery.util';
import {
...
@Component({
  selector: 'g-upper-buttons',
  templateUrl: './upper-buttons.component.html',
  styleUrls: ['./upper-buttons.component.css'],

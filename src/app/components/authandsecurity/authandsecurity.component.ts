...
@Component({
  selector: 'app-authandsecurity',
  templateUrl: './authandsecurity.component.html',
  styleUrls: ['./authandsecurity.component.css'],
  providers: [PageService]
})
export class AuthandsecurityComponent implements OnInit {
  ...
  setUrl() {
    var url = this.cms.authDomain + "/authentication/" + this.selectedApp;
